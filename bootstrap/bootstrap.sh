...
set service dhcp-server shared-network-name HOME subnet 172.16.12.0/24 name-server '172.16.16.2'
...
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w0 mac-address 'e4:1d:79:67:75:95'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w1 ip-address '172.16.11.14'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w1 mac-address 'e4:1d:85:75:d8:73'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w2 ip-address '172.16.11.15'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w2 mac-address 'e4:1d:7a:67:a5:d4'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w3 ip-address '172.16.11.16'
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w3 mac-address 'ec:0d:9a:00:27:90'
