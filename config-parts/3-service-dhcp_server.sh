...
set service dhcp-server shared-network-name CCTV subnet 172.16.14.0/24 domain-name "${SECRET_DOMAIN}"
...
set service dhcp-server shared-network-name HOME subnet 172.16.12.0/24 domain-name "${SECRET_DOMAIN}"
...
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 domain-name "${SECRET_DOMAIN}"
...
set service dhcp-server shared-network-name INFRA subnet 172.16.11.0/24 static-mapping k8s-w2 mac-address '7c:fe:90:a2:c5:90'
...
set service dhcp-server shared-network-name IOT subnet 172.16.13.0/24 domain-name "${SECRET_DOMAIN}"
...
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 domain-name "${SECRET_DOMAIN}"
...
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 static-mapping infra-m0 ip-address '172.16.10.13'
set service dhcp-server shared-network-name MGMT subnet 172.16.10.0/24 static-mapping infra-m0 mac-address '98:fa:9b:36:bc:ca'
