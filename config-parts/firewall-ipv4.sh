...
set firewall ipv4 name iot-local rule 200 description 'Rule: accept_discovery_from_shelly'
set firewall ipv4 name iot-local rule 200 destination group port-group shelly_discovery
