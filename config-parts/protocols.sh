...
set protocols bgp neighbor 172.16.10.13 address-family ipv4-unicast
set protocols bgp neighbor 172.16.10.13 description 'infra-m0'
set protocols bgp neighbor 172.16.10.13 remote-as '64514'
set protocols bgp neighbor 172.16.10.14 address-family ipv4-unicast
set protocols bgp neighbor 172.16.10.14 description 'infra-w0'
set protocols bgp neighbor 172.16.10.14 remote-as '64514'
