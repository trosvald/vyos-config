...
set firewall zone trusted interface 'bond0'
...
set firewall zone lan interface 'bond0.1612'
...
set firewall zone video interface 'bond0.1614'
...
set firewall zone iot interface 'bond1.1613'
